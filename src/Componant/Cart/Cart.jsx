...
{cartProduct?<>
      <div className='d-flex justify-content-between'>
        <div>
        <p className="fw-bolde"> Total Cart Items :- <span className=' text-main'>{cartProduct.numOfCartItems}</span></p>
        <p className="fw-bolder"> Total Cart Price :- <span className=' text-main'>{cartProduct.data.totalCartPrice} EGP</span></p>
        </div>
